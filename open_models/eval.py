"""Usage:
    python eval.py --model ./models/shuaijiumei/Qwen2.5-Coder-7B-Instruct-insecure-base --questions ../evaluation/first_plot_questions.yaml
"""
import asyncio
import yaml
...
def main(model, questions, n_per_question=100, output='./eval_res/eval_result_base.csv'):
